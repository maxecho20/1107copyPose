...
export const GoogleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" {...props}>
        ...
        <path fill="#4CAF50" d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.223,0-9.657-3.356-11.303-8H2.394v6.948C5.454,39.807,13.468,44,24,44z"></path>
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C44.434,36.336,48,30.562,48,24C48,22.659,47.862,21.35,47.611,20.083z"></path>
    </svg>
);
...
export const FacebookIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 24 24" {...props}><path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95z"></path></svg>
);

export const WhatsAppIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 24 24" {...props}><path d="M16.75 13.96c.25.42.45.78.52.92.21.42.34.92.25 1.41-.09.5-.42.92-.83 1.17-.42.25-1.09.42-1.75.25-1.25-.25-2.5-1-3.59-1.92-1.34-1.17-2.5-2.67-2.75-3.25-.25-.58-.04-1.09.21-1.42.25-.33.5-.5.71-.5.21 0 .42.04.58.08.17.04.33.08.5.21.17.13.25.33.33.5.08.17.13.33.17.5.04.17.04.33 0 .5-.04.17-.13.33-.21.42-.08.08-.17.17-.25.25-.13.13-.17.25-.08.42.25.58.75 1.34 1.5 1.92.75.58 1.42 1 2.09 1.25.25.08.42 0 .58-.08s.25-.17.33-.25.17-.17.25-.25c.08-.08.17-.17.25-.25.17-.17.33-.25.5-.25.17 0 .33 0 .5.04.17.04.25.08.33.17.13.08.21.21.25.33s.04.33.04.46zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path></svg>
);